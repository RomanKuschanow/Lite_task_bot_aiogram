"""Peewee migrations -- 003_Timer.py.
...
def migrate(migrator, database, fake=False, **kwargs):
    ...
    class Timer(pw.Model):
        ...
        pause_date = pw.DateTimeField()
        is_paused = pw.BooleanField(constraints=[SQL("DEFAULT False")], default=False)
        is_work = pw.BooleanField(constraints=[SQL("DEFAULT True")], default=True)
